...
A lightweight, header-only Modern C++20 stopwatch utility for measuring code execution time with optional callbacks.
...
- **Header-only C++20**: Zero compiled library linkage; clean compilation on MSVC, Clang, and GCC.
